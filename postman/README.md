...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/jiogamesstore/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/jiogamesstore/postman/application.json
```
