...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/sngfynd/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/sngfynd/postman/application.json
```
