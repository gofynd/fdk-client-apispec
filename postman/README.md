...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/jiox2/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/jiox2/postman/application.json
```
