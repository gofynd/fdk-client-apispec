...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.8.5-prerelease-v2/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.8.5-prerelease-v2/postman/application.json
```
