...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.8.4-prerelease-v3/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.8.4-prerelease-v3/postman/application.json
```
