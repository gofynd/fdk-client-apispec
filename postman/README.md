...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/pbgz0/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/pbgz0/postman/application.json
```
