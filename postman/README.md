...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/fp-v1.8.6/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/fp-v1.8.6/postman/application.json
```
