...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.9.0-unreleased/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.9.0-unreleased/postman/application.json
```
