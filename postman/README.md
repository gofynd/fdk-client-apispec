...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.8.2-prerelease-v1/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.8.2-prerelease-v1/postman/application.json
```
