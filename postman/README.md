...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.7.8/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.7.8/postman/application.json
```
