...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.7.7-unreleased/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/v1.7.7-unreleased/postman/application.json
```
