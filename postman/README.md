...
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/jiomarketz5/postman/platform.json
```

2. Application Front APIs Collection Link
```md
https://raw.githubusercontent.com/gofynd/fdk-client-apispec/jiomarketz5/postman/application.json
```
